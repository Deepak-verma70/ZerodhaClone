...
function Footer() {
    return (  
      ...
      <div className="container border-top mt-5">
        ...
        <div>
             <a href="" style={{textDecoration:"none"}} className='text-muted dee'>NSE</a>
        
            <a href="" style={{textDecoration:"none"}} className='text-muted dee'>BSE</a>
        
            <a href="" style={{textDecoration:"none"}} className='text-muted dee'>MCX</a>
            
            <a href="" style={{textDecoration:"none"}} className='text-muted dee'>Terms & Conditions</a>
            
            <a href="" style={{textDecoration:"none"}} className='text-muted dee'>Policies and Procedure</a>
        
            <a href="" style={{textDecoration:"none"}} className='text-muted dee'>Private Policy</a>
        
            <a href="" style={{textDecoration:"none"}} className='text-muted dee'>Disclosure</a>
